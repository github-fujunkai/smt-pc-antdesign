...
const App = () => {
  ...
  const saveWorkStationStorage = (e) => {
    ...
    if (formCreate.getFieldValue('workStation') && formCreate.getFieldValue('workStation') != '') {
      localStorage.setItem('workStation', formCreate.getFieldValue('workStation'));
    }
  };
  ...
  const showModal = (action, record) => {
    ...
    if (action === 'update' && record) {
      ...
      if (localStorage.getItem('workStation')) {
        formCreate.setFieldValue('workStation', localStorage.getItem('workStation'));
      }
    }
  ...
  */
  ...
  const fetchData = () => {
    ...
    if (repairTimeStart) {
      params.repairTimeStart = repairTimeStart.format('YYYY-MM-DD') + ' 00:00:00';
    }
    if (repairTimeEnd) {
