...
const App = () => {
  ...
  const fetchData = () => {
    ...
    const { factoryId, workshopId, areaId, deviceOrderNum, tableNo, slot, itemCode, itemStatus } =
    ...
    http
      .post(config.API_PREFIX + api.tracePreventPage + `?${qs.stringify(params)}`, {})
      .then((res) => {
  ...
  const [columns, setColumns] = useState([
    {
      title: <FormattedMessage id="pages.searchTable.areaNameProcess" defaultMessage="产线" />,
    ...
    {
      title: <FormattedMessage id="mes.machine.serial" defaultMessage="机器序号" />,
    ...
    {
      title: <FormattedMessage id="mes.cart" defaultMessage="台车" />,
      dataIndex: 'tableNo',
      key: 'tableNo',
      width: 100,
      fixed: 'left',
    ...
    {
      title: <FormattedMessage id="mes.feeder" defaultMessage="料站" />,
      dataIndex: 'slot',
      key: 'slot',
      width: 100,
      fixed: 'left',
    ...
    {
      title: <FormattedMessage id="audit.material" defaultMessage="料号" />,
      dataIndex: 'itemCode',
      key: 'itemCode',
      width: 100,
      fixed: 'left',
    ...
    {
      title: <FormattedMessage id="mes.program" defaultMessage="程序名" />,
      dataIndex: 'program',
      key: 'program',
      width: 100,
    },
    {
      title: <FormattedMessage id="mes.wo" defaultMessage="工单号" />,
      dataIndex: 'projectNo',
      key: 'projectNo',
      width: 100,
    },
    {
      title: <FormattedMessage id="plant.region" defaultMessage="城市/厂区" />,
      dataIndex: 'factoryAreaNameProcess',
      key: 'factoryAreaNameProcess',
      width: 100,
    },
    {
      title: <FormattedMessage id="plant.workshop" defaultMessage="车间" />,
      dataIndex: 'workshopAreaNameProcess',
      key: 'workshopAreaNameProcess',
      width: 100,
    },
    {
      title: <FormattedMessage id="mes.lane" defaultMessage="道数" />,
      dataIndex: 'division',
      key: 'division',
      width: 100,
      sorter: true,
    ...
    {
      title: <FormattedMessage id="mes.materialstatus" defaultMessage="物料状态" />,
    ...
    {
      title: <FormattedMessage id="mes.feederType" defaultMessage="Feeder类型" />,
      dataIndex: 'feederType',
      key: 'feederType',
      width: 100,
    },
    {
      title: <FormattedMessage id="mes.feederSn" defaultMessage="Feeder编号" />,
      dataIndex: 'feederSn',
      key: 'feederSn',
      width: 100,
    },
    {
      title: <FormattedMessage id="mes.feederStatus" defaultMessage="Feeder状态" />,
  ...
  const exportData = () => {
    ...
    http
      .post(config.API_PREFIX + api.tracePreventExportData + `?${query}`)
      .then((res) => {
              ...
              <Col span={8}>
                <Form.Item label="台车" name="tableNo">
                  <Select
                    placeholder="请选择"
                    allowClear
                    options={dictBaseAll?.tableNo
                      ?.sort((a, b) => parseInt(a.dictValue, 10) - parseInt(b.dictValue, 10))
                      ?.map((item) => ({
                        value: item.dictKey,
                        label: item.dictValue,
                      }))}
